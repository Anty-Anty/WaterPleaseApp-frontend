...
// input: last watering date and number of days to next watering 
// uses today's date
export function daysUntilNextWatering(lastWateredDate, daysToNextWatering) {
    ...
    nextWateringDate.setDate(nextWateringDate.getDate() + Number(daysToNextWatering));
    ...
    return Math.round((nextWateringDate - today) / MS_PER_DAY);
}